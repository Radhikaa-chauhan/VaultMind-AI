...
import type { SpendTracker, SpendAlerts } from '@vaultmind/observe';
import type { TransactionProvenance } from '@vaultmind/protect';
 ...
 * @example
 * ```ts
 * import { PaySentryX402Adapter } from '@vaultmind/x402';
 * import { PolicyEngine } from '@vaultmind/control';
 * import { SpendTracker, SpendAlerts } from '@vaultmind/observe';
 * import { TransactionProvenance } from '@vaultmind/protect';
 *
