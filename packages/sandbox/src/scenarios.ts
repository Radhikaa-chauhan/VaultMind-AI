...
}): TestScenario['transactions'][number] {
  return {
    agentId: (overrides.agentId ?? 'test-agent') as AgentId,
    ...
    service: overrides.service as ServiceId | undefined,
 ...
 */
export const SCENARIO_BASIC_PAYMENT: TestScenario = {
  name: 'Basic Payment',
 ...
 */
export const SCENARIO_OVERSPEND: TestScenario = {
 ...
 */
export const SCENARIO_APPROVAL_REQUIRED: TestScenario = {
 ...
 */
export const SCENARIO_BLOCKED_RECIPIENT: TestScenario = {
 ...
 */
export const SCENARIO_MULTI_PROTOCOL: TestScenario = {
  name: 'Multi-Protocol',
 ...
 */
export const SCENARIO_DISPUTE: TestScenario = {
  name: 'Dispute Flow',
 ...
 */
export const SCENARIO_RATE_SPIKE: TestScenario = {
  name: 'Rate Spike',
  ...
  expectedOutcomes: Array.from({ length: 10 }, () => 'completed' as const),
};

/**
 * Timeout scenario: Payment to a slow endpoint that times out.
 */
export const SCENARIO_TIMEOUT: TestScenario = {
  name: 'Timeout',
 ...
 */
export const SCENARIO_MULTI_AGENT: TestScenario = {
  name: 'Multi-Agent',
