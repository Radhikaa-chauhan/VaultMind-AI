...
```typescript
import { SpendTracker, SpendAnalytics, SpendAlerts } from '@vaultmind/observe';
...
```typescript
import { createPolicyMiddleware } from '@vaultmind/control';
...
```typescript
import { TransactionProvenance, DisputeManager, RecoveryEngine } from '@vaultmind/protect';
...
```typescript
// Core transaction type (from @vaultmind/core/src/types.ts)
...
```bash
npm install @vaultmind/core @vaultmind/observe @vaultmind/control
```
...
```typescript
import { PolicyEngine } from '@vaultmind/control';
import { SpendTracker } from '@vaultmind/observe';
...
**Try PaySentry:**
```bash
npm install @vaultmind/core @vaultmind/observe @vaultmind/control @vaultmind/protect @vaultmind/sandbox
```
